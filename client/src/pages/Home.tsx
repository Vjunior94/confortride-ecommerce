    ...
    <div className="min-h-screen">
      ...
      <section className="bg-zinc-950 py-16 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          <h2 className="text-3xl md:text-4xl font-bold mb-3 text-white" style={{ fontFamily: "'Barlow Condensed', sans-serif" }}>
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <a
              href="https://wa.me/554396021892?text=Ola%21%20Vim%20pelo%20site%20e%20gostaria%20de%20saber%20mais%20sobre%20os%20encostos"
              target="_blank"
              rel="noopener noreferrer"
            >
              <Button size="lg" className="bg-green-600 hover:bg-green-700 text-white font-semibold px-8 gap-2">
            ...
            <Link href="/produtos">
              <Button size="lg" variant="outline" className="border-zinc-700 text-zinc-300 hover:bg-zinc-800 font-semibold px-8">
                Ver Produtos
              </Button>
            </Link>
          </div>
